...
Install as a skill if I have npm: npx skills add agentspace-so/skills --skill agentspace -g

If not, do this instead: curl -fsSL https://agentspace.so/install.sh | bash
```
